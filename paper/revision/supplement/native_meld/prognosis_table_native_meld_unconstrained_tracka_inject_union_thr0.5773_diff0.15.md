# Prognosis association (adjusted): native MELD + rs-fMRI TrackA (inject/union)

- Cohort: Intermediate+Difficult; n=58 (ILAE12=38, ILAE3456=20)
- Constraints/policy: MELD(native) unconstrained; rs-fMRI uses laterality+area constraint (a30_t80); union=top2 fMRI + top1 T1 (relabel CC); TrackA gate: t1_conf_thr=0.5773, diff_thr=0.15.
...
| TrackA (fusion, inject/union) | 0/58 (0.0%) | 20/38 (52.6%) | 2/20 (10.0%) | 9.79 | [2.32, 64.2] | 0.0006 |
...
| TrackA (fusion, inject/union) | 0/58 (0.0%) | 19/38 (50.0%) | 1/20 (5.0%) | 11.5 | [2.42, 112] | 0.0006 |
...
| Intersection | 47/58 (81.0%) | 8/38 (21.1%) | 0/20 (0.0%) | 17 | [1.61, 2.4e+03] | 0.0111 |
| TrackA (fusion, inject/union) | 0/58 (0.0%) | 20/38 (52.6%) | 2/20 (10.0%) | 8.24 | [2.09, 48.2] | 0.0010 |
...
| TrackA (fusion, inject/union) | 0.453 [0.016, 0.979] | 0.000 [0.000, 0.000] | 7.3e-05 | 1.38 | [1.14, 1.85] | 2.9e-05 |
