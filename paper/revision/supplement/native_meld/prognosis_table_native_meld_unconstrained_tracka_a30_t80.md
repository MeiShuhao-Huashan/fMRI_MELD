# Prognosis association (native MELD; supplementary)

- Cohort: Intermediate+Difficult; n=58 (ILAE12=38, ILAE3456=20)
- Constraints/policy: Post-processing policy: MELD(native) and Intersection have no area constraints; rs-fMRI uses laterality + area constraint (a30_t80); TrackA=fusion(native MELD + rs-fMRI; takeover gate).
...
| Intersection | 47/58 (81.0%) | 8/38 (21.1%) | 0/20 (0.0%) | 17 | [1.61, 2.4e+03] | 0.0111 |
| TrackA (fusion) | 0/58 (0.0%) | 20/38 (52.6%) | 2/20 (10.0%) | 8.24 | [2.09, 48.2] | 0.0010 |
